-- ParkPunkt go-live safety controls.
-- Existing seeded/provider inventory becomes non-public until explicitly verified.
...
-- Evidence objects are private and addressed by an officer-owned storage path.
