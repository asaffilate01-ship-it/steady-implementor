...
const DICT = {
  en: {
    ...
    "drive.view.map": "Map",
    "drive.view.list": "List",
    "drive.filters": "Filters",
    "drive.filter.available": "Spaces available",
    "drive.filter.ev": "EV charging",
    "drive.filter.accessible": "Accessible",
    "drive.filter.clear": "Clear filters",
    "drive.map.label": "Parking locations map",
    "drive.destination": "Destination",
    "drive.perHour": "per hour",
    "drive.noResults": "No parking locations match these filters.",
    "drive.viewDetails": "View location and price",
    "drive.data.live": "Live availability",
    "drive.data.updated": "Availability updated",
    ...
    "drive.arrived.cta": "I've arrived — pay for parking",
    ...
    "drive.arrived.no": "No, let me enter it",
    "drive.arrived.manual.street": "Street or car park",
    "drive.arrived.manual.code": "Zone / tariff code",
    "drive.arrived.manual.find": "Find location",
    "drive.arrived.provider": "Routed to",
    "drive.arrived.fee": "ParkPunkt booking fee",
    "drive.arrived.operatorNet": "Paid to operator",
    "drive.arrived.pay": "Pay & start parking",
    "drive.arrived.settled": "Settled instantly — receipt in your history.",
    "drive.arrived.nomatch": "No matching zone found. Try another street or code.",
    ...
    "drive.scan.pay": "Pay ticket & release barrier",
    "drive.scan.hint": "Barrier opens on ANPR once the operator confirms payment.",
    "drive.scan.permDenied": "Camera permission denied. Upload a photo or type the number.",
    "drive.scan.needSite": "Select the car park this ticket belongs to:",
    ...
    "op.ratePerHour": "€ / h",
    "op.kpi.gross": "Gross revenue",
    "op.kpi.platformFee": "Platform fee",
    "op.kpi.net": "Net payout",
    "op.payout.title": "Payout summary",
    "op.payout.pending": "Pending",
    "op.payout.paid": "Paid",
    "op.payout.gross": "Gross",
    ...
    "adm.commission.saved": "Commission saved",
    "adm.commission.org": "Organization",
    "adm.commission.provider": "Provider",
  ...
  de: {
    ...
    "drive.history": "Letzte Zahlungen",
    ...
    "drive.view.map": "Karte",
    "drive.view.list": "Liste",
    "drive.filters": "Filter",
    "drive.filter.available": "Freie Plätze",
    "drive.filter.ev": "E-Ladestation",
    "drive.filter.accessible": "Barrierefrei",
    "drive.filter.clear": "Filter zurücksetzen",
    "drive.map.label": "Karte der Parkmöglichkeiten",
    "drive.destination": "Ziel",
    "drive.perHour": "pro Stunde",
    "drive.noResults": "Keine Parkmöglichkeit entspricht diesen Filtern.",
    "drive.viewDetails": "Standort und Preis anzeigen",
    "drive.data.live": "Live-Verfügbarkeit",
    "drive.data.updated": "Verfügbarkeit aktualisiert vor",
    ...
    "drive.arrived.no": "Nein, manuell eingeben",
    "drive.arrived.manual.street": "Straße oder Parkhaus",
    "drive.arrived.manual.code": "Zonen- / Tarifcode",
    "drive.arrived.manual.find": "Standort finden",
    "drive.arrived.provider": "Weitergeleitet an",
    "drive.arrived.fee": "ParkPunkt-Buchungsgebühr",
    "drive.arrived.operatorNet": "An Betreiber ausgezahlt",
    "drive.arrived.pay": "Bezahlen & Parken starten",
    "drive.arrived.settled": "Sofort abgerechnet — Beleg in Ihrer Historie.",
    "drive.arrived.nomatch": "Keine passende Zone gefunden. Andere Straße oder Code probieren.",
    ...
    "drive.scan.pay": "Ticket bezahlen & Schranke öffnen",
    "drive.scan.hint": "Die Schranke öffnet per ANPR, sobald der Betreiber die Zahlung bestätigt.",
    "drive.scan.permDenied": "Kamerazugriff verweigert. Foto hochladen oder Nummer eingeben.",
    "drive.scan.needSite": "Parkhaus für dieses Ticket auswählen:",
    ...
    "op.ratePerHour": "€ / Std.",
    "op.kpi.gross": "Bruttoerlös",
    "op.kpi.platformFee": "Plattformgebühr",
    "op.kpi.net": "Netto-Auszahlung",
    "op.payout.title": "Auszahlungsübersicht",
    "op.payout.pending": "Ausstehend",
    "op.payout.paid": "Bezahlt",
    "op.payout.gross": "Brutto",
    ...
    "adm.commission.saved": "Kommission gespeichert",
    "adm.commission.org": "Organisation",
    "adm.commission.provider": "Anbieter",
