...
function TermsPage() {
  return (
    <LegalLayout title="Terms of Service" updated="1 August 2026">
      <p>
        ...
        {legalConfig.companyName} ("ParkPunkt", "we", "us").
      </p>
      <h2>1. Acceptance</h2>
      <p>
      ...
      <ul>
        <li>
          A session begins when you confirm start and ends when you tap end or when an enabled
          operator integration records the session end.
        </li>
      ...
      <h2>4. Payments</h2>
      <p>
        Where payment processing is enabled, payments are submitted to the payment provider shown
        during checkout. A session ending does not by itself prove that settlement has completed.
        Refunds follow the operator's applicable policy and statutory rights.
      </p>
      ...
      <p>
        ...
        repeatedly fail to pay. Account-closure requests can be submitted through the published
        privacy contact.
      </p>
      <h2>7. Liability</h2>
      <p>
